...
const SpicesPage = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['spices', searchTerm, sortOption, currentPage],
    queryFn: async () => {
      ...
      <div className="premium-container py-8 flex-grow">
        ...
        {isLoading && (
          <div className="text-center py-20">
            ...
            <p className="text-xl text-gray-500 mt-4">Loading spices...</p>
          </div>
        )}
        ...
        {!isLoading && products.length === 0 && (
          <div className="text-center py-20 animate-fade-in">
            ...
            <p className="text-xl text-gray-500 mb-4">No spices found</p>
